;;TO DO
;;- make it so recursive functions can be generated
;;- write a function that allows for more control over repeated variables by collapsing what is returned by choose-insertion-points
